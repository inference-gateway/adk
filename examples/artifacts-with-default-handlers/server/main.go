...
// Artifacts with Default Handlers A2A Server Example
//
// This example demonstrates an A2A server using default task handlers with
// automatic artifact extraction. Tools create artifacts using ArtifactHelper,
// and the default handlers automatically extract and attach them to tasks.
//
...
Artifact Details:
{
  ...
  "parts": [
	...
	agent, err := server.NewAgentBuilder(logger).
		...
		WithSystemPrompt("You are a helpful AI assistant with access to tools that create downloadable artifacts. When users request reports, diagrams, or data exports, use the appropriate tools to create these as artifacts. The default task handlers will automatically extract and attach the artifacts to your responses. Be concise and helpful in your responses.").
	...
	logger.Info("✅ server created with default handlers and artifact extraction")
